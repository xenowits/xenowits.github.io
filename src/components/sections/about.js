  ...
  return (
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>Hello! I'm Abhishek, a Computer Science & Engineering student at NIT Trichy.</p>

            <p>
              I love to build things that make the world a safer and easier place to live in. I believe
